...
### Fixed
- Cleaned the Python lint baseline so the Network Monitor CI workflow passes.
- Fixed ICMP ping output handling to read the subprocess result correctly.
- Preserved local-time alert and maintenance-window behavior while using timezone-aware datetime operations.
